...
// Single authoritative Master Workbook V2 regression.
void main() {
  test('Rajahmundry 15-Aug-2026: four authoritative Moon timestamps', () {
    final window = MoonNakshatraWindow.forUtc(DateTime.utc(2026, 8, 15, 6, 46));
...
void _near(DateTime actual, DateTime expected) {
  ...
  expect(difference, lessThanOrEqualTo(const Duration(seconds: 2)),
      reason: 'Expected $expected ±2s; got $actual (difference $difference)');
}
